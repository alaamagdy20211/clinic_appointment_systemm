...
from .views import ScheduleListView, ScheduleCreateView, ScheduleExceptionCreateView, DoctorDashboardView
...
urlpatterns = [
    ...
    path('my-schedule/dashboard/', DoctorDashboardView.as_view(), name='schedule-dashboard'),
]